...
type HealthCheckResponse struct {
	...
	Status HealthCheckResponse_ServingStatus `protobuf:"varint,1,opt,name=status,proto3,enum=grpc_server.healthcheck.v1.HealthCheckResponse_ServingStatus" json:"status,omitempty"`
}
...
var file_healthcheck_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x13, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x68, 0x65, 0x61, 0x6c, 0x74, 0x68,
	...
	0x43, 0x68, 0x65, 0x63, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0xb6, 0x01, 0x0a,
	...
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x36, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x68, 0x65, 0x61, 0x6c,
	...
	0x4f, 0x57, 0x4e, 0x10, 0x03, 0x32, 0x75, 0x0a, 0x06, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x12,
	0x6b, 0x0a, 0x05, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x12, 0x27, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e,
	...
	0x74, 0x1a, 0x28, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x68, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x63,
	0x68, 0x65, 0x63, 0x6b, 0x2e, 0x76, 0x31, 0x2e, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x43, 0x68,
	...
	0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x54, 0x69, 0x6d, 0x52, 0x75,
	0x74, 0x74, 0x65, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x68, 0x65,
	0x61, 0x6c, 0x74, 0x68, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_healthcheck_proto_goTypes = []interface{}{
	(HealthCheckResponse_ServingStatus)(0), // 0: grpc_server.healthcheck.v1.HealthCheckResponse.ServingStatus
	(*HealthCheckRequest)(nil),             // 1: grpc_server.healthcheck.v1.HealthCheckRequest
	(*HealthCheckResponse)(nil),            // 2: grpc_server.healthcheck.v1.HealthCheckResponse
}
var file_healthcheck_proto_depIdxs = []int32{
	0, // 0: grpc_server.healthcheck.v1.HealthCheckResponse.status:type_name -> grpc_server.healthcheck.v1.HealthCheckResponse.ServingStatus
	1, // 1: grpc_server.healthcheck.v1.Health.Check:input_type -> grpc_server.healthcheck.v1.HealthCheckRequest
	2, // 2: grpc_server.healthcheck.v1.Health.Check:output_type -> grpc_server.healthcheck.v1.HealthCheckResponse
