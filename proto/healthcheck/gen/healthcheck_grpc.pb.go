...
const (
	Health_Check_FullMethodName = "/grpc_server.healthcheck.v1.Health/Check"
)
...
// HealthServer is the grpc_server API for Health service.
...
var Health_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "grpc_server.healthcheck.v1.Health",
